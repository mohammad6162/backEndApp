...
route.options('*', cors());
route.get('/ping', nocache, ping)
route.get('/rtc/:channel/:role/:tokentype/:uid', nocache, generateRTCToken);
route.get('/rtm/:uid/', nocache, generateRTMToken);
route.get('/rte/:channel/:role/:tokentype/:uid', nocache, generateRTEToken);
